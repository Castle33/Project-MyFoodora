...
public class TargetProfitDeliveryCost implements ITargetProfitPolicy {
	...
	/**
	 * firstly, based on last month performance and the indicated target profit we calculate the desired delivery cost
	...
	public double computeProfitStrategyBased(double serviceFee, double markupPercentage, double deliveryCost, double targetProfit, List<Order> listOfOrders, Calendar initDate, Calendar finDate){
		...
		System.out.println("Computing deliveryCost based on last month performance and targetProfit for this month");
		...
		System.out.println("Computing this month profit based on deliveryCost computation");
